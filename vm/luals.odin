...
// makac.luals_setup reads it back from makac.luals_stub and writes it into a
// project's data directory.
Luals_Stub :: #load("../luals/makac.lua", string)

// expose_luals_stub publishes the embedded stub as makac.luals_stub. Called
